...
**MimIR** is a modular compiler infrastructure built on a pure, dependently-typed intermediate representation (IR) designed for clarity, composability, and optimization.
